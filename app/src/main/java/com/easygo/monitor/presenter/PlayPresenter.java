...
import com.easygo.monitor.model.DeviceEncrypt;
import com.easygo.monitor.model.EZOpenCameraInfo;
import com.easygo.monitor.model.EZOpenDeviceInfo;
import com.easygo.monitor.utils.CameraCaptureCache;
import com.easygo.monitor.utils.DataManager;
import com.easygo.monitor.utils.EZCameraDBManager;
...
public class PlayPresenter extends BaseRealmPresenter {
    ...
    public void setQuality(final String deviceSerial, final int cameraNo, final int videolevel) {
        ...
        Log.d(TAG, "开始设置清晰度" + "(--> " + videolevel + ") : " + deviceSerial);
