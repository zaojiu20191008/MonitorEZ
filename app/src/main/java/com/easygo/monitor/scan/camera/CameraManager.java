...
import com.easygo.monitor.scan.main.PlanarYUVLuminanceSource;
...
public final class CameraManager {
    ...
    public void requestAutoFocus(Handler handler, int message) {
        if (camera != null && previewing) {
            ...
            try {
                ...
                EZLog.warnLog(TAG, "Unexpected exception while focusing", re);
            }
        }
    }
    ...
    public Rect getFramingRect() {
        ...
        if (framingRect == null) {
            ...
            framingRect = new Rect(leftOffset, topOffset, leftOffset + width, topOffset + height);
            EZLog.debugLog(TAG, "Calculated framing rect: " + framingRect);
    ...
    public void setManualFramingRect(int width, int height) {
        if (initialized) {
            ...
            int topOffset = (screenResolution.y - height) / 2;
            framingRect = new Rect(leftOffset, topOffset, leftOffset + width, topOffset + height);
            EZLog.debugLog(TAG, "Calculated manual framing rect: " + framingRect);
            framingRectInPreview = null;
        } else {
